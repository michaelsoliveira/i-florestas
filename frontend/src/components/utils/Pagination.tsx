...
export const Pagination = function Pagination({ perPage = 10, totalItems, orderBy, order, currentPage, onPageChanged, pageNeighbours }: any) {
        ...
        if (totalPages > totalBlocks) {
            ...
            switch (true) {
                ...
                case (hasLeftSpill && !hasRightSpill): {
                    ...
                    pages = [1, LEFT_PAGE, ...extraPages, ...pages];
                    break;
                }
                ...
                case (hasLeftSpill && hasRightSpill):
                default: {
                    pages = [1, LEFT_PAGE, ...pages, RIGHT_PAGE];
                    break;
                }
            }
            ...
            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                ...
                <div>
                    ...
                    <a href="#" onClick={(event) => {
                        event.preventDefault()
                        if (currentPage < totalPages) gotoPage(currentPage + 1)
                    }} className={classNames("relative inline-flex items-center px-2 py-2 rounded-r-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50",
