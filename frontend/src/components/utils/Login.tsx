    ...
    <div>
        ...
        <div className="rounded-md flex flex-col items-center">
          ...
          <div className="mt-10 relative w-full">
            <input
              ...
              type="password"
              className="peer h-10 w-full border-b border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-custom-green"
              placeholder="michaelsoliveira@gmail.com"
            />
            <label
              htmlFor="password"
              className="absolute left-0 -top-3.5 text-gray-600 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm"
        ...
        <div className="mx-auto flex flex-row items-center justify-center py-2">
          ...
          >
            <span className="absolute left-0 inset-y-0 flex items-center pl-3">
              <LockClosedIcon
                className="h-5 w-5 text-gray-50 group-hover:opacity-50"
                aria-hidden="true"
              />
            </span>
            Sign in
      ...
      <div className="flex flex-col justify-between items-center w-full">
        <div className="mt-4 flex items-center justify-between">
          ...
          <a
            href="#"
            className="text-xs text-center text-gray-500 uppercase w-96"
          >
        ...
        <div className="flex flex-col justify-center items-center max-w-full w-full">
          ...
          >
            ...
            <h1 className="px-4 py-2 w-5/6 text-center text-gray-600 font-medium">
              Sign in with Google
            </h1>
          </a>
        </div>
