                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="border border-gray-200 p-4 mt-4 rounded-md">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2">
                                    ...
                                    { !isAddMode && (
                                        <div className="p-4 mb-4 text-sm text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
                                            <span className="font-medium">Aviso!</span> A Forma de Inventário não pode ser alterada pois podem existir árvores que dependam desta informação. 
                                        </div>
                                    )}
                                </div>
                            </div>
