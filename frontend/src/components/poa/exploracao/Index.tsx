...
const Exploracao = ({ ut, loadUts }:any) => {
    ...
    const loadData = useCallback(async () => {
        ...
        const totEspecies = data?.reduce((acc: any, curr: any) => acc + Number(curr.total_especie), 0)
        const totVolCorte = data?.reduce((acc: any, curr: any) => acc + Number(curr.volume_corte), 0.0)
        const totVolCorteHa = data?.reduce((acc: any, curr: any) => acc + Number(curr.volume_corte_ha), 0.0)
