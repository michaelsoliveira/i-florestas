                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className='grid grid-cols-2 md:grid-cols-6 gap-4'>
                                ...
                                <div className="border border-gray-200 p-4 rounded-md col-span-6 relative w-full">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 bg-gray-100 px-4 py-2">
                                        <div className='md:mt-[6px] md:col-span-2'>
                                            <Select
                            ...
                            {isAddMode && (
                                <div className='flex flex-col lg:flex-row space-y-4 mt-2 lg:space-y-0 space-x-0 lg:space-x-4'>
                                    <div className='w-full grid border border-gray-200 rounded-lg p-4 justify-around'>
