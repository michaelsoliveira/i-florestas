        ...
        client.post(`/arvore`, { upa: upa?.id, ut: ut?.id, ...data })
            .then((response: any) => {
                ...
                if (!error) {
                    ...
                    router.push(`/arvore?page=1&utId=${ut.id}`)
                } else {
            ...
            <div className="py-6 flex flex-col justify-center sm:py-12 bg-gray-50">
                ...
                <div className="relative py-3 w-full px-4 lg:max-w-4xl mx-auto">
                    <div className='flex flex-row items-center justify-between border border-custom-green text-white shadow-lg bg-custom-green py-4 sm:rounded-t-xl'>
                        ...
                        <div>
                            {isAddMode ? (
                                <h1 className='text-xl'>Cadastro de Árvore</h1>
                            ) : (
                                <h1 className='text-xl'>Editar Árvore</h1>
                            )}
                        </div>
                        <div></div>
                    </div>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div>
                                <div className='flex items-center justify-between pt-4'>
                                    <Link href="/arvore" className="text-center w-1/5 bg-gray-100 transition-all delay-150 hover:bg-gray-200 duration-200 p-3 rounded-md">Voltar</Link>
