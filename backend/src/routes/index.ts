...
routes.post('/poa/change-situacao', Authentication(), new PoaController().changeSituacao)
...
routes.get('/ut/get-geo-json-shape', Authentication(), new UtController().getGeoJsonShape)
...
routes.post('/ut/convert-utm-geo/', Authentication(), new UtController().convertUtmToGeo)
routes.post('/ut/convert-geo-utm/', Authentication(), new UtController().convertGeoToUtm)
...
routes.post('/especie/multiples', Authentication(), new EspecieController().deleteEspecies)
...
routes.get('/arvore/get-geo-json', Authentication(), new ArvoreController().getGeoJson)
