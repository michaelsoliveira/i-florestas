...
var Index_1 = require("src/components/especie/Index");
...
var EspecieIndex = function EspecieIndex() {
  var client = react_1.useContext(AuthContext_1.AuthContext).client;

  var _a = react_1.useContext(LoadingContext_1.LoadingContext),
      loading = _a.loading,
  ...
  var _e = react_1.useState([]),
      currentEspecies = _e[0],
      setCurrentEspecies = _e[1];

  var _f = react_1.useState(0),
      totalPages = _f[0],
      setTotalPages = _f[1];

  var _g = react_1.useState('especie.nome'),
      orderBy = _g[0],
      setOrderBy = _g[1];

  var _h = react_1.useState('asc'),
      order = _h[0],
      setOrder = _h[1];
  ...
  var poa = provider_1.useAppSelector(function (state) {
    return state.poa;
  });
  var loadEspecies = react_1.useCallback(function (itemsPerPage, currentPage) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            url = "/especie?poa=" + (poa === null || poa === void 0 ? void 0 : poa.id) + "&page=" + (currentPage ? currentPage : currentPagePagination) + "&perPage=" + (itemsPerPage ? itemsPerPage : perPage) + "&orderBy=" + orderBy + "&order=" + order;
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , client.get("/especie?page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order + "&poa=" + (poa === null || poa === void 0 ? void 0 : poa.id) + "&projetoId=" + (projeto === null || projeto === void 0 ? void 0 : projeto.id) + "&search=" + search.toLowerCase())];
          ...
          case 2:
            return [4
            /*yield*/
            , client.get("/especie?page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order + "&poa=" + (poa === null || poa === void 0 ? void 0 : poa.id) + "&projetoId=" + (projeto === null || projeto === void 0 ? void 0 : projeto.id))];
  ...
  var changeItemsPerPage = function changeItemsPerPage(evt) {
    onPageChanged({
  ...
  return React.createElement("div", null, React.createElement(Index_1["default"], {
  ...
  }), currentEspecies && React.createElement(Pagination_1.Pagination, {
    perPage: itemsPerPage,
