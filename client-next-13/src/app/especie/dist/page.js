...
var EspecieIndex = function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, client.get("/especie?page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order + "&poa=" + (poa === null || poa === void 0 ? void 0 : poa.id) + "&projetoId=" + (projeto === null || projeto === void 0 ? void 0 : projeto.id) + "&search=" + search.toLowerCase())];
                case 1:
                    data = (_a.sent()).data;
                    ...
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, client.get("/especie?page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order + "&poa=" + (poa === null || poa === void 0 ? void 0 : poa.id) + "&projetoId=" + (projeto === null || projeto === void 0 ? void 0 : projeto.id))];
                case 3:
                    data = (_a.sent()).data;
                    paginatedData = __assign(__assign({ name: name }, paginatedData), { totalPages: Math.ceil((data === null || data === void 0 ? void 0 : data.count) / perPage), totalItems: data === null || data === void 0 ? void 0 : data.count });
                    _a.label = 4;
    ...
    return (React.createElement("div", null,
        ...
        currentEspecies && (React.createElement(Pagination_1.Pagination, { perPage: itemsPerPage, totalItems: totalItems, orderBy: orderBy, order: order, currentPage: currentPage, onPageChanged: onPageChanged, pageNeighbours: 3 }))));
};
