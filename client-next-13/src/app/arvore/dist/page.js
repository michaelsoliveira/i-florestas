...
var ArvoreIndex = function () {
    ...
    var loadArvores = react_1.useCallback(function (itemsPerPage, currentPage) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setLoading(true);
                    currentPagePagination = (pagination.name === navigation_1.usePathname() && pagination.currentPage) ? pagination.currentPage : 1;
    ...
    }); }, [client, order, orderBy, pagination.currentPage, pagination.name, pagination.perPage, navigation_1.usePathname, setLoading, ut === null || ut === void 0 ? void 0 : ut.id]);
    ...
    var onPageChanged = function (paginatedData) { return __awaiter(void 0, void 0, void 0, function () {
        var name, currentPage, perPage, totalPages, orderBy, order, search, utId, data, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    name = paginatedData.name, currentPage = paginatedData.currentPage, perPage = paginatedData.perPage, totalPages = paginatedData.totalPages, orderBy = paginatedData.orderBy, order = paginatedData.order, search = paginatedData.search, utId = paginatedData.utId;
                    if (!search) return [3 /*break*/, 2];
                    return [4 /*yield*/, client.get("/arvore/get-all?utId=" + utId + "&page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order + "&search=" + search.toLowerCase())];
                case 1:
                    data = (_a.sent()).data;
                    ...
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, client.get("/arvore/get-all?utId=" + (utId ? utId : ut === null || ut === void 0 ? void 0 : ut.id) + "&page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order)];
                case 3:
                    data = (_a.sent()).data;
                    paginatedData = __assign(__assign({ name: name }, paginatedData), { totalPages: Math.ceil((data === null || data === void 0 ? void 0 : data.count) / perPage), totalItems: data === null || data === void 0 ? void 0 : data.count });
                    _a.label = 4;
    ...
    return (React.createElement("div", null,
        React.createElement(Index_1["default"], { currentArvores: currentArvores, loadArvores: loadArvores, currentPage: currentPage, orderBy: orderBy, order: order, onPageChanged: onPageChanged, perPage: itemsPerPage, changeItemsPerPage: changeItemsPerPage, exportCsv: exportCsv }),
