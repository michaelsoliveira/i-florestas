...
var ProjetoUsersIndex = function () { return __awaiter(void 0, void 0, void 0, function () {
    var roles, client, _a, loading, setLoading, _b, currentPage, setCurrentPage, _c, itemsPerPage, setItemsPerPage, _d, totalItems, setTotalItems, _e, currentUsers, setCurrentUsers, _f, orderBy, setOrderBy, _g, order, setOrder, pagination, dispatch, projeto, pathname, loadUsers, onPageChanged, changeItemsPerPage;
    return __generator(this, function (_h) {
        switch (_h.label) {
            ...
            case 1:
                roles = (_h.sent()).roles;
                client = AuthContext_1.useAuthContext().client;
                _a = react_1.useContext(LoadingContext_1.LoadingContext), loading = _a.loading, setLoading = _a.setLoading;
                _b = react_1.useState(1), currentPage = _b[0], setCurrentPage = _b[1];
                _c = react_1.useState(10), itemsPerPage = _c[0], setItemsPerPage = _c[1];
                _d = react_1.useState(0), totalItems = _d[0], setTotalItems = _d[1];
                _e = react_1.useState([]), currentUsers = _e[0], setCurrentUsers = _e[1];
                _f = react_1.useState('users.username'), orderBy = _f[0], setOrderBy = _f[1];
                _g = react_1.useState('asc'), order = _g[0], setOrder = _g[1];
                pagination = hooks_1.useAppSelector(function (state) { return state.pagination; });
                dispatch = hooks_1.useAppDispatch();
                projeto = react_1.useContext(ProjetoContext_1.ProjetoContext).projeto;
                pathname = navigation_1.usePathname();
                loadUsers = react_1.useCallback(function (itemsPerPage, currentPage) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                }); }, [client, order, orderBy, pagination.currentPage, pagination.name, projeto === null || projeto === void 0 ? void 0 : projeto.id, setLoading]);
                ...
                onPageChanged = function (paginatedData) { return __awaiter(void 0, void 0, void 0, function () {
