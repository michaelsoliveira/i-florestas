...
var ProjetoUsersIndex = function ProjetoUsersIndex(_a) {
  var roles = _a.roles;
  var client = react_1.useContext(AuthContext_1.AuthContext).client;

  var _b = react_1.useContext(LoadingContext_1.LoadingContext),
      loading = _b.loading,
  ...
  var _g = react_1.useState('users.username'),
      orderBy = _g[0],
      setOrderBy = _g[1];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , client.get("/projeto/" + (projeto === null || projeto === void 0 ? void 0 : projeto.id) + "/users?page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order + "&search=" + search.toLowerCase())];
          ...
          case 2:
            return [4
            /*yield*/
            , client.get("/projeto/" + (projeto === null || projeto === void 0 ? void 0 : projeto.id) + "/users?page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order)];
  ...
  return React.createElement("div", null, React.createElement(Users_1["default"], {
