...
var Index_1 = require("src/components/obs-arvore/Index");
...
var ObservacoesIndex = function () {
    ...
    var _e = react_1.useState([]), currentObservacoes = _e[0], setCurrentObservacoes = _e[1];
    ...
    var loadObservacoes = react_1.useCallback(function (itemsPerPage, currentPage) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, client.get("/obs-arvore?page=" + (currentPage ? currentPage : currentPagePagination) + "&perPage=" + itemsPerPage + "&orderBy=" + orderBy + "&order=" + order)];
                case 1:
                    data = (_a.sent()).data;
                    console.log(data);
                    setTotalItems(data === null || data === void 0 ? void 0 : data.count);
                    setCurrentObservacoes(data === null || data === void 0 ? void 0 : data.observacoes);
                    setLoading(false);
                    return [2 /*return*/];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, client.get("/obs-arvore?page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order + "&search=" + search.toLowerCase())];
                case 1:
                    data = (_a.sent()).data;
                    ...
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, client.get("/obs-arvore?page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order)];
                case 3:
                    data = (_a.sent()).data;
                    paginatedData = __assign(__assign({ name: name }, paginatedData), { totalPages: Math.ceil((data === null || data === void 0 ? void 0 : data.count) / perPage), totalItems: data === null || data === void 0 ? void 0 : data.count });
                    _a.label = 4;
                case 4:
                    ...
                    setOrder(order);
                    setTotalItems(data === null || data === void 0 ? void 0 : data.count);
                    setCurrentObservacoes(data === null || data === void 0 ? void 0 : data.users);
                    return [2 /*return*/];
            }
        });
    }); };
    ...
    return (React.createElement("div", null,
        React.createElement(Index_1["default"], { currentObservacoes: currentObservacoes, loading: loading, loadObservacoes: loadObservacoes, currentPage: currentPage, orderBy: orderBy, order: order, onPageChanged: onPageChanged, perPage: itemsPerPage, changeItemsPerPage: changeItemsPerPage }),
...
exports["default"] = withAuthentication_1["default"](ObservacoesIndex);
