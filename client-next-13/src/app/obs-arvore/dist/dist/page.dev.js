...
var ObservacoesIndex = function ObservacoesIndex() {
  ...
  var _e = react_1.useState([]),
      currentObservacoes = _e[0],
      setCurrentObservacoes = _e[1];

  var _f = react_1.useState('nome'),
      orderBy = _f[0],
      setOrderBy = _f[1];

  var _g = react_1.useState('asc'),
      order = _g[0],
      setOrder = _g[1];
  ...
  var loadObservacoes = react_1.useCallback(function (itemsPerPage, currentPage) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , client.get("/obs-arvore?page=" + (currentPage ? currentPage : currentPagePagination) + "&perPage=" + itemsPerPage + "&orderBy=" + orderBy + "&order=" + order)];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , client.get("/obs-arvore?page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order + "&search=" + search.toLowerCase())];
          ...
          case 2:
            return [4
            /*yield*/
            , client.get("/obs-arvore?page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order)];
