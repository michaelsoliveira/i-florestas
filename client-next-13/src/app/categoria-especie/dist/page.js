...
var CategoriaIndex = function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, client.get("/categoria?page=" + currentPagePagination + "&perPage=" + itemsPerPage + "&order=asc&orderBy=nome&poa=" + (poa === null || poa === void 0 ? void 0 : poa.id) + "&projetoId=" + (projeto === null || projeto === void 0 ? void 0 : projeto.id))];
                case 1:
                    data = (_a.sent()).data;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, client.get("/categoria?page=" + currentPage + "&perPage=" + perPage + "&search=" + search.toLowerCase() + "&poa=" + (poa === null || poa === void 0 ? void 0 : poa.id) + "&projetoId=" + (projeto === null || projeto === void 0 ? void 0 : projeto.id))];
                case 1:
                    data = (_a.sent()).data;
                    ...
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, client.get("/categoria?page=" + currentPage + "&perPage=" + perPage + "&projetoId=" + (projeto === null || projeto === void 0 ? void 0 : projeto.id))];
                case 3:
                    data = (_a.sent()).data;
    ...
    return (React.createElement("div", null,
        React.createElement(Index_1["default"], { currentCategorias: currentCategorias, loading: loading, loadCategorias: function () { return loadCategorias(itemsPerPage); }, currentPage: currentPage, onPageChanged: onPageChanged, perPage: itemsPerPage, changeItemsPerPage: changeItemsPerPage }),
