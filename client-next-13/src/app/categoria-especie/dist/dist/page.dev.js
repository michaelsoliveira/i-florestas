...
var Index_1 = require("src/components/categoria-especie/Index");

var router_1 = require("next/router");

var ProjetoContext_1 = require("src/contexts/ProjetoContext");

var CategoriaIndex = function CategoriaIndex() {
  ...
  var _e = react_1.useState([]),
      currentCategorias = _e[0],
      setCurrentCategorias = _e[1];
  ...
  var _loadCategorias = react_1.useCallback(function (itemsPerPage) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , client.get("/categoria?page=" + currentPagePagination + "&perPage=" + itemsPerPage + "&order=asc&orderBy=nome&poa=" + (poa === null || poa === void 0 ? void 0 : poa.id) + "&projetoId=" + (projeto === null || projeto === void 0 ? void 0 : projeto.id))];
  ...
  }, [client, pagination.currentPage, pagination.name, poa.id, projeto === null || projeto === void 0 ? void 0 : projeto.id]);

  react_1.useEffect(function () {
    _loadCategorias(itemsPerPage);
  }, [_loadCategorias, itemsPerPage]);
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , client.get("/categoria?page=" + currentPage + "&perPage=" + perPage + "&search=" + search.toLowerCase() + "&poa=" + (poa === null || poa === void 0 ? void 0 : poa.id) + "&projetoId=" + (projeto === null || projeto === void 0 ? void 0 : projeto.id))];

          case 1:
            data = _a.sent().data;
            paginatedData = __assign(__assign({}, paginatedData), {
          ...
          case 2:
            return [4
            /*yield*/
            , client.get("/categoria?page=" + currentPage + "&perPage=" + perPage + "&projetoId=" + (projeto === null || projeto === void 0 ? void 0 : projeto.id))];

          case 3:
            data = _a.sent().data;
            paginatedData = __assign({
              name: name
            }, paginatedData);
            _a.label = 4;
  ...
  return React.createElement("div", null, React.createElement(Index_1["default"], {
    ...
    loadCategorias: function loadCategorias() {
      return _loadCategorias(itemsPerPage);
    },
