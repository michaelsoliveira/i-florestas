...
var Index_1 = require("src/components/equacao/Index");
...
var ProjetoEquacoesIndex = function ProjetoEquacoesIndex() {
  ...
  var _e = react_1.useState([]),
      currentEquacoes = _e[0],
      setCurrentEquacoes = _e[1];
  ...
  var loadEquacoes = react_1.useCallback(function (itemsPerPage, currentPage) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , client.get("/projeto/" + (projeto === null || projeto === void 0 ? void 0 : projeto.id) + "/eq-volume?page=" + (currentPage ? currentPage : currentPagePagination) + "&perPage=" + itemsPerPage + "&orderBy=" + orderBy + "&order=" + order)];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , client.get("/projeto/" + (projeto === null || projeto === void 0 ? void 0 : projeto.id) + "/eq-volume?page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order + "&search=" + search.toLowerCase())];
          ...
          case 2:
            return [4
            /*yield*/
            , client.get("/projeto/" + (projeto === null || projeto === void 0 ? void 0 : projeto.id) + "/eq-volume?page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order)];
