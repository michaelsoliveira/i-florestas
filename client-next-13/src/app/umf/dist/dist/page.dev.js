...
var UmfIndex = function UmfIndex() {
  ...
  var projeto = react_1.useContext(ProjetoContext_1.ProjetoContext).projeto; // eslint-disable-next-line react-hooks/exhaustive-deps

  var loadUmfs = react_1.useCallback(function (itemsPerPage, currentPage) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            return [4
            /*yield*/
            , client.get("/umf/find-by-projeto/" + (projeto === null || projeto === void 0 ? void 0 : projeto.id) + "?page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order)];
