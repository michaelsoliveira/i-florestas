...
var Index_1 = require("src/components/upa/Index");

var UpaIndex = function UpaIndex() {
  ...
  var loadUpas = react_1.useCallback(function (itemsPerPage, currentPage) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            url = "/upa?page=" + (currentPage ? currentPage : currentPagePagination) + "&perPage=" + (itemsPerPage ? itemsPerPage : pagination.perPage) + "&orderBy=" + orderBy + "&order=" + order + "&umf=" + umf.id;
            return [4
            /*yield*/
            , client.get(url)];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            return [4
            /*yield*/
            , client.get("/upa?page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order + "&umf=" + umf)];
...
exports["default"] = withAuthentication_1["default"](UpaIndex);