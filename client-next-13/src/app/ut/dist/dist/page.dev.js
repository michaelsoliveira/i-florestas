...
var Index_1 = require("src/components/ut/Index");

var UtIndex = function UtIndex() {
  ...
  var _f = react_1.useState('descricao'),
      orderBy = _f[0],
      setOrderBy = _f[1];
  ...
  var upa = provider_1.useAppSelector(function (state) {
    return state.upa;
  });
    ...
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            setLoading(true);
            currentPagePagination = pagination.name === router.pathname && pagination.currentPage ? pagination.currentPage : currentPage;
            perPage = pagination.perPage ? pagination.perPage : itemsPerPage;
            url = process.env.NEXT_PUBLIC_API_URL + "/ut?page=" + currentPagePagination + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order + "&upa=" + upa.id;
            return [4
            /*yield*/
            , client.get(url)];
  ...
  }, [client, order, orderBy, pagination === null || pagination === void 0 ? void 0 : pagination.currentPage, pagination === null || pagination === void 0 ? void 0 : pagination.name, pagination.perPage, router.pathname, upa.id]);
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            return [4
            /*yield*/
            , client.get("/ut?page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order + "&upa=" + upa)];
