...
var PoaIndex = function PoaIndex() {
  ...
  var _g = react_1.useState('descricao'),
      orderBy = _g[0],
      setOrderBy = _g[1];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            return [4
            /*yield*/
            , client.get("/poa?page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order + "&umf=" + umf)];
