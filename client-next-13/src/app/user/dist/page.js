...
var UserIndex = function (_a) {
    ...
    var _g = react_1.useState(0), totalPages = _g[0], setTotalPages = _g[1];
    var _h = react_1.useState('user.username'), orderBy = _h[0], setOrderBy = _h[1];
    var _j = react_1.useState('ASC'), order = _j[0], setOrder = _j[1];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, client.get("/empresa/" + empresaId + "/users?page=" + (currentPage ? currentPage : currentPagePagination) + "&perPage=" + itemsPerPage + "&orderBy=" + orderBy + "&order=" + order)];
                case 1:
                    data = (_a.sent()).data;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, client.get("/empresa/" + empresaId + "/users?page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order + "&search=" + search.toLowerCase())];
                case 1:
                    data = (_a.sent()).data;
                    ...
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, client.get("/empresa/" + empresaId + "/users?page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order)];
                case 3:
                    data = (_a.sent()).data;
                    paginatedData = __assign(__assign({ name: name }, paginatedData), { totalPages: Math.ceil((data === null || data === void 0 ? void 0 : data.count) / perPage), totalItems: data === null || data === void 0 ? void 0 : data.count });
                    _a.label = 4;
    ...
    return (React.createElement("div", null,
        "test",
        React.createElement(Users_1["default"], { currentUsers: currentUsers, loading: loading, loadUsers: loadUsers, currentPage: currentPage, orderBy: orderBy, order: order, onPageChanged: onPageChanged, perPage: itemsPerPage, changeItemsPerPage: changeItemsPerPage, empresaId: empresaId }),
