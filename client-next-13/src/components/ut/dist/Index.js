...
var Index = function (_a) {
    ...
    var maxNumUt = (currentUts === null || currentUts === void 0 ? void 0 : currentUts.length) > 0 ? Math.max.apply(Math, currentUts === null || currentUts === void 0 ? void 0 : currentUts.map(function (ut) { return Number(ut.numero_ut); })) : 0;
    var newUt = react_1.useRef();
    ...
    var saveAuto = function (data) {
        newUt.current.click();
    };
    function addAutomatico() {
        showModal({
            ...
            content: React.createElement("div", null,
                React.createElement(AddAuto_1["default"], { ref: newUt, maxNumUt: maxNumUt, loadUts: loadUts }))
        });
    }
                ...
                React.createElement("div", { className: "shadow overflow-y-auto border-b border-gray-200 w-full sm:rounded-lg" },
                    ...
                    React.createElement("table", { className: "min-w-full divide-y divide-gray-200" },
                        ...
                        React.createElement("tbody", { className: "bg-white divide-y divide-gray-200" }, filteredUts === null || filteredUts === void 0 ? void 0 : filteredUts.map(function (ut) { return (React.createElement("tr", { key: ut.id },
                            ...
                            (upa === null || upa === void 0 ? void 0 : upa.tipo) === 1 && (React.createElement("td", { className: "px-3 py-2 whitespace-nowrap" },
