...
var Index = function (_a) {
    ...
    function getUmfsDefaultOptions() {
        var data = umfs === null || umfs === void 0 ? void 0 : umfs.map(function (umf, idx) {
            return {
                label: umf.nome,
                value: umf.id
            };
    ...
    return (React.createElement("div", null,
        ...
        loading ? (React.createElement("div", { className: "flex flex-row items-center justify-center h-56" }, "Loading...")) : (React.createElement("div", { className: "flex flex-col p-6 lg:px-16" },
                    ...
                    React.createElement("table", { className: "min-w-full divide-y divide-gray-200" },
                        React.createElement("thead", { className: "bg-gray-50" },
                            React.createElement("tr", null,
                                ...
                                React.createElement("th", { className: "w-[5rem]", scope: "col" },
                                    React.createElement("div", { className: "flex flex-row items-center px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer" },
                                        "Situa\u00E7\u00E3o",
                                        sorted
                                            ? (React.createElement(solid_1.ChevronUpIcon, { className: "w-5 h-5" }))
                                            : (React.createElement(solid_1.ChevronDownIcon, { className: "w-5 h-5" })))),
                                React.createElement("th", { scope: "col", className: "w-[5rem]" },
                                    React.createElement("div", { className: "flex flex-row items-center px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer" },
                                        "Data \u00DAltimo Planejamento",
                                        sorted
                                            ? (React.createElement(solid_1.ChevronUpIcon, { className: "w-5 h-5" }))
                                            : (React.createElement(solid_1.ChevronDownIcon, { className: "w-5 h-5" })))),
                                React.createElement("th", { scope: "col", className: "w-1/12 px-6 py-3" },
                                    React.createElement("span", { className: "sr-only" }, "Edit")))),
                        React.createElement("tbody", { className: "bg-white divide-y divide-gray-200" }, filteredPoas === null || filteredPoas === void 0 ? void 0 : filteredPoas.map(function (poa) {
                            var _a, _b;
                            return (React.createElement("tr", { key: poa.id },
                                ...
                                React.createElement("td", { className: "px-3 py-2 whitespace-nowrap" },
                                    React.createElement("div", { className: "flex flex-col items-starter" },
                                        React.createElement("div", { className: "text-sm font-medium text-gray-900" }, poa === null || poa === void 0 ? void 0 : poa.descricao))),
                                React.createElement("td", { className: "px-3 py-2 whitespace-nowrap" },
                                    React.createElement("div", { className: "flex flex-col items-starter" },
                                        React.createElement("div", { className: "text-sm font-medium text-gray-900" }, (_a = poa === null || poa === void 0 ? void 0 : poa.situacao_poa) === null || _a === void 0 ? void 0 : _a.nome))),
                                React.createElement("td", { className: "px-3 py-2 whitespace-nowrap" },
                                    React.createElement("div", { className: "text-sm text-gray-900" }, (poa === null || poa === void 0 ? void 0 : poa.data_ultimo_plan) ? new Date((_b = poa === null || poa === void 0 ? void 0 : poa.data_ultimo_plan) === null || _b === void 0 ? void 0 : _b.toString()).toLocaleDateString('pt-BR') : '')),
