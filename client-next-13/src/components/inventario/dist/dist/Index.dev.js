...
var Index = function Index() {
  ...
  var _j = react_1.useState('iso-8859-1'),
      encoding = _j[0],
      setEncoding = _j[1];
  ...
  var loadUpas = function loadUpas(inputValue, callback) {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        data = upas.filter(function (upa) {
          return (upa === null || upa === void 0 ? void 0 : upa.descricao.includes(inputValue)) || (upa === null || upa === void 0 ? void 0 : upa.descricao.toLowerCase().includes(inputValue));
        });
  ...
  var loadUmfs = function loadUmfs(inputValue, callback) {
    return __awaiter(void 0, void 0, void 0, function () {
      var data;
      return __generator(this, function (_a) {
        data = umfs.filter(function (umf) {
          return (umf === null || umf === void 0 ? void 0 : umf.nome.includes(inputValue)) || (umf === null || umf === void 0 ? void 0 : umf.nome.toLowerCase().includes(inputValue));
        });
  ...
  var getUts = react_1.useCallback(function () {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [4
            /*yield*/
            , client.get("/ut?upaId=" + (upa === null || upa === void 0 ? void 0 : upa.id))];
  ...
  var handleImportInventario = function handleImportInventario() {
    return __awaiter(void 0, void 0, void 0, function () {
      var data_1, e_1;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            if (uts.length === 0) return [2
            /*return*/
            , alert_1["default"].warn('Por favor, crie as UTs antes de realizar a importação')];
            return [4
            /*yield*/
            , client.get('/poa?order=asc&orderBy=descricao')];

          case 1:
            data_1 = _a.sent().data;
            if (!((data_1 === null || data_1 === void 0 ? void 0 : data_1.count) === 0 || poa.id === '')) return [3
            /*break*/
            , 2];
            return [2
            /*return*/
            , alert_1["default"].warn('Por favor, crie ou selecione um POA para iniciar a importação do inventário')];

          case 2:
            setLoading(true);
            return [4
            /*yield*/
            , client.post("/arvore/import-inventario?upaId=" + (upa === null || upa === void 0 ? void 0 : upa.id), {
              columns: columnData,
              data: rowData
  ...
  var onUploadAccepted = function onUploadAccepted(result) {
  ...
  return React.createElement("div", null, React.createElement("div", {
    ...
    var getRootProps = _a.getRootProps,
        acceptedFile = _a.acceptedFile,
        ProgressBar = _a.ProgressBar,
        getRemoveFileProps = _a.getRemoveFileProps;
    return React.createElement(React.Fragment, null, React.createElement("div", {
    ...
    }, ["iso-8859-1", "utf-8"].map(function (pageSize) {
      ...
      className: ""
    }, React.createElement("a", __assign({}, getRootProps(), {
      ...
      className: "ml-2"
    }, uploading ? "Abrindo..." : "Abrir Planilha"))), React.createElement("div", {
      className: "lg:grid lg:grid-cols-2 lg:gap-2"
    }, acceptedFile && React.createElement(React.Fragment, null, React.createElement("div", {
      className: "inline-block align-baseline"
    }, acceptedFile.name), React.createElement(Button_1.Button, __assign({}, getRemoveFileProps(), {
      className: "text-red-700 hover:cursor-pointer justify-center w-24"
    }), "Remove"))), React.createElement("div", {
      className: "col-span-4 pt-1"
    ...
    className: "ml-2"
  }, "Modelo"))), data.length > 0 && React.createElement("a", {
  ...
  }, "Importar")), React.createElement("div", {
    className: "flex flex-col p-6"
  }, React.createElement("div", {
    className: "pb-2"
  }, React.createElement("h1", {
    className: "text-xl font-semibold"
  }, "Importa\xE7\xE3o do Invent\xE1rio")), React.createElement("div", {
    className: "flex flex-col lg:flex-row lg:items-center lg:justify-items-center py-4 bg-gray-100 rounded-lg"
  }, React.createElement("div", {
    className: "grid grid-cols-1 md:grid-cols-2 gap-4 w-full lg:w-3/5 px-4"
