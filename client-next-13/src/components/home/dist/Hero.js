...
var Hero = function (_a) {
    ...
    var showLogin = function () {
        showModal({
            type: 'submit', hookForm: 'hook-form', options: false,
            content: React.createElement(Tabs_1["default"], null)
        });
    };
    return (React.createElement("div", { className: "container mx-auto px-6 py-8" },
        ...
        !session && (React.createElement("div", { className: "mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start" },
            React.createElement("div", { className: "" },
                React.createElement("a", { href: "#", className: "w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-green-600 hover:bg-green-700 md:py-4 md:text-lg md:px-10", onClick: showLogin }, "Iniciar")),
