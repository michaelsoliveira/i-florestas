...
var ChangeActive_2 = require("./poa/ChangeActive");
...
function Navigation(_a) {
    ...
    var formRefProjeto = react_1.createRef();
    var formRefPoa = react_1.createRef();
    ...
    var changePoaAtivo = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    var changeProjetoModal = function () {
        showModal({ title: 'Alterar Projeto Ativo', onConfirm: changeProjetoAtivo, styleButton: styles_1.styles.greenButton, confirmBtn: 'Ativar Projeto', content: React.createElement(ChangeActive_1.ChangeActive, { ref: formRefProjeto }) });
    };
    var changePoaModal = function () {
        showModal({ title: 'Alterar Poa Ativo', onConfirm: changePoaAtivo, styleButton: styles_1.styles.greenButton, confirmBtn: 'Ativar Poa', content: React.createElement(ChangeActive_2.ChangeActive, { ref: formRefPoa }) });
    };
                                                        ...
                                                        React.createElement(react_2.Popover, null, function (_a) {
                                                            ...
                                                            return (React.createElement(React.Fragment, null,
                                                                ...
                                                                React.createElement(react_2.Popover.Panel, { className: classnames_1["default"]("z-30 absolute -mr-8 -mt-12 w-72 -right-60 origin-left bg-white divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none") }, (_b = subMenu.subMenuItems) === null || _b === void 0 ? void 0 : _b.map(function (subsubMenu, subKey) { return (React.createElement("div", { key: subKey, className: 'inline-flex px-2 py-2 w-full rounded-md text-sm text-gray-700' },
                                                                    React.createElement(react_2.Popover.Button, { as: Link_1.Link, href: subsubMenu === null || subsubMenu === void 0 ? void 0 : subsubMenu.href, onClick: close, className: classnames_1["default"](!(subsubMenu === null || subsubMenu === void 0 ? void 0 : subsubMenu.icon) && 'pl-8', navigation_1.usePathname() === (subsubMenu === null || subsubMenu === void 0 ? void 0 : subsubMenu.href) && 'bg-gray-100', 'group flex rounded-md text-start items-center w-full px-2 py-2 text-sm transition duration-500 ease-in-out hover:bg-gray-100') },
                        ...
                        React.createElement("div", { className: "ml-4 flex items-center md:ml-6" },
                            React.createElement(react_2.Menu, { as: "div", className: "ml-3 relative" },
                                React.createElement("div", null,
                                    React.createElement(react_2.Menu.Button, { className: "rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-green-700 focus:ring-white" },
                                        React.createElement("div", { className: "bg-gray-200 p-1 rounded-full text-gray-400 hover:text-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-green-800 focus:ring-white" },
                                ...
                                React.createElement(react_2.Transition, { as: react_1.Fragment, enter: "transition ease-out duration-100", enterFrom: "transform opacity-0 scale-95", enterTo: "transform opacity-100 scale-100", leave: "transition ease-in duration-75", leaveFrom: "transform opacity-100 scale-100", leaveTo: "transform opacity-0 scale-95" },
                                    React.createElement(react_2.Menu.Items, { className: "origin-top-right absolute z-20 right-0 mt-2 w-48 shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none rounded-md" }, ["Mudar Projeto Ativo", "Mudar Poa Ativo"].map(function (item, key) { return (React.createElement(react_2.Menu.Item, { key: key }, function (_a) {
                                        var active = _a.active;
                                        return (React.createElement(react_2.Disclosure.Button, { as: 'a', href: '#', className: classnames_1["default"](active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700'), onClick: function () { key === 0 ? changeProjetoModal() : changePoaModal(); }, "aria-hidden": "true" }, item));
                                    })); })))),
                            React.createElement(react_2.Menu, { as: "div", className: "ml-3 relative" },
                                React.createElement("div", null,
                                    React.createElement(react_2.Menu.Button, { className: "rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-green-700 focus:ring-white" },
                                        React.createElement("span", { className: "sr-only" }, "Open user menu"),
                                        ((_b = session.user) === null || _b === void 0 ? void 0 : _b.image)
                                            ? (React.createElement("img", { className: "h-8 w-10 rounded-full", src: (_c = session.user) === null || _c === void 0 ? void 0 : _c.image, alt: "" }))
                                            : (React.createElement("div", { className: 'ml-auto bg-gray-300 flex-shrink-0 p-1 rounded-full' },
                                                React.createElement(outline_2.UserIcon, { className: "block h-6 w-6 text-black", "aria-hidden": "true" }))))),
                                React.createElement(react_2.Transition, { as: react_1.Fragment, enter: "transition ease-out duration-100", enterFrom: "transform opacity-0 scale-95", enterTo: "transform opacity-100 scale-100", leave: "transition ease-in duration-75", leaveFrom: "transform opacity-100 scale-100", leaveTo: "transform opacity-0 scale-95" },
                                    React.createElement(react_2.Menu.Items, { className: "origin-top-right absolute z-20 right-0 mt-2 w-48 shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none rounded-md" }, userNavigation.map(function (item, key) { return (React.createElement(react_2.Menu.Item, { key: key }, function (_a) {
                                        var active = _a.active;
            ...
            React.createElement(react_2.Disclosure.Panel, { className: "md:hidden" },
                ...
                session ? (React.createElement("div", { className: "pt-4 pb-3 border-t border-gray-700" },
                    React.createElement("div", { className: "flex items-center px-5" },
                        React.createElement("div", { className: "flex-shrink-0" }, session && ((_d = session.user) === null || _d === void 0 ? void 0 : _d.image) ? (React.createElement("img", { className: "h-10 w-10 rounded-full", src: (_e = session.user) === null || _e === void 0 ? void 0 : _e.image, alt: "" })) : (React.createElement("div", { className: 'ml-auto bg-gray-300 flex-shrink-0 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white' },
                            React.createElement(outline_2.UserIcon, { className: "block h-6 w-6 text-black", "aria-hidden": "true" })))),
                        React.createElement("div", { className: "ml-3" },
                            React.createElement("div", { className: "text-base font-medium leading-none text-gray-700" }, session && ((_f = session.user) === null || _f === void 0 ? void 0 : _f.name)),
                            React.createElement("div", { className: "text-sm font-medium leading-none text-gray-600" }, session && ((_g = session.user) === null || _g === void 0 ? void 0 : _g.email))),
                        React.createElement(react_2.Menu, { as: "div", className: "ml-3 relative flex items-center justify-end  w-full" },
                            React.createElement("div", null,
                                React.createElement(react_2.Menu.Button, { className: "rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-green-700 focus:ring-white" },
                                    React.createElement("div", { className: "bg-gray-200 p-1 rounded-full text-gray-400 hover:text-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-green-800 focus:ring-white" },
                                        React.createElement("svg", { className: 'fill-gray-800', xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24" },
                            ...
                            React.createElement(react_2.Transition, { as: react_1.Fragment, enter: "transition ease-out duration-100", enterFrom: "transform opacity-0 scale-95", enterTo: "transform opacity-100 scale-100", leave: "transition ease-in duration-75", leaveFrom: "transform opacity-100 scale-100", leaveTo: "transform opacity-0 scale-95" },
                                React.createElement(react_2.Menu.Items, { className: "origin-top-right absolute z-20 right-0 mt-2 w-48 shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none rounded-md" }, ["Mudar Projeto Ativo", "Mudar Poa Ativo"].map(function (item, key) { return (React.createElement(react_2.Menu.Item, { key: key }, function (_a) {
                                    var active = _a.active;
                                    return (React.createElement(react_2.Menu.Button, { as: 'a', href: '#', className: classnames_1["default"](active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700'), onClick: function () { key === 0 ? changeProjetoModal() : changePoaModal(); }, "aria-hidden": "true" }, item));
                                })); }))))),
