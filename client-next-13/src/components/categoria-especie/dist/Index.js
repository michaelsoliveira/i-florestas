...
var Index = function (_a) {
    ...
    var _c = react_1.useState([]), checkedCategorias = _c[0], setCheckedCategorias = _c[1];
    ...
    var defaultOptions = react_1.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        var response, poas;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    var _g = ModalContext_1.useModalContext(), hideModal = _g.hideModal, showModal = _g.showModal, store = _g.store;
                ...
                React.createElement("div", { className: "shadow overflow-y-auto border-b border-gray-200 w-full sm:rounded-lg" },
                    ...
                    React.createElement("table", { className: "min-w-full divide-y divide-gray-200" },
                        ...
                        React.createElement("tbody", { className: "bg-white divide-y divide-gray-200" }, filteredCategorias === null || filteredCategorias === void 0 ? void 0 : filteredCategorias.map(function (categoria) { return (React.createElement("tr", { key: categoria.id },
                            ...
                            React.createElement("td", { className: "px-3 py-2 whitespace-nowrap" },
                                React.createElement("div", { className: "text-sm text-gray-900" }, getFuste(Number(categoria === null || categoria === void 0 ? void 0 : categoria.criterio_fuste)))),
                            React.createElement("td", { className: "px-3 py-2 whitespace-nowrap" },
