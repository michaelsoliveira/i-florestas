...
var Index = function Index(_a) {
  var currentArvores = _a.currentArvores,
      ...
      perPage = _a.perPage,
      loadArvores = _a.loadArvores,
      exportCsv = _a.exportCsv;

  var _b = react_1.useState(currentArvores),
      filteredArvores = _b[0],
      setFilteredArvores = _b[1];
  ...
  var umf = hooks_1.useAppSelector(function (state) {
    return state.umf;
  });
  var upa = hooks_1.useAppSelector(function (state) {
    return state.upa;
  });
  var ut = hooks_1.useAppSelector(function (state) {
    return state.ut;
  });
  ...
  var loadUpas = function loadUpas(inputValue, callback) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4
            /*yield*/
            , client.get("/upa/search/q?descricao=" + inputValue)];

          case 1:
            response = _a.sent();
            data = response.data;
            callback(data === null || data === void 0 ? void 0 : data.map(function (upa) {
              return {
                value: upa.id,
                label: upa.descricao
              };
  ...
  var loadUts = function loadUts(inputValue, callback) {
    return __awaiter(void 0, void 0, void 0, function () {
      var response, data;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4
            /*yield*/
            , client.get("/ut/search/q?numero_ut=" + inputValue)];

          case 1:
            response = _a.sent();
            data = response.data;
            callback(data === null || data === void 0 ? void 0 : data.map(function (ut) {
              return {
                value: ut.id,
                label: ut.numero_ut
              };
  ...
  var loadUmfs = function loadUmfs(inputValue, callback) {
    return __awaiter(void 0, void 0, void 0, function () {
      var response, data;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4
            /*yield*/
            , client.get("/umf/search/q?nome=" + inputValue)];

          case 1:
            response = _a.sent();
            data = response.data;
            callback(data === null || data === void 0 ? void 0 : data.map(function (umf) {
              return {
                value: umf.id,
                label: umf.nome
              };
  ...
  var defaultUmfsOptions = react_1.useCallback(function () {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4
            /*yield*/
            , client.get("/umf/find-by-projeto/" + (projeto === null || projeto === void 0 ? void 0 : projeto.id) + "?orderBy=nome&order=asc")];

          case 1:
            response = _a.sent();
            umfs = response.data.umfs;
            setUmfs(umfs);
            compareUmf = umfs ? umfs.find(function (u) {
              return u.id === umf.id;
            }) : null;
  ...
  var defaultUpasOptions = react_1.useCallback(function () {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4
            /*yield*/
            , client.get("/upa?orderBy=descricao&order=asc&umf=" + (umf === null || umf === void 0 ? void 0 : umf.id))];
          ...
          case 1:
            ...
            compareUpa = upas ? upas.find(function (u) {
              return u.id === upa.id;
            }) : null;
  ...
  var defaultUtsOptions = react_1.useCallback(function () {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4
            /*yield*/
            , client.get("/ut?orderBy=nome&order=asc&upa=" + (upa === null || upa === void 0 ? void 0 : upa.id))];
          ...
          case 1:
            ...
            compareUt = uts ? uts.find(function (u) {
              return u.id === ut.id;
            }) : null;
  ...
  var selectUmf = function selectUmf(umf) {
    return __awaiter(void 0, void 0, void 0, function () {
      var response, upas;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , client.get("/upa?orderBy=descricao&order=asc&umf=" + umf.value)];
  ...
  var selectUpa = function selectUpa(upa) {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            upaSelected = upas.find(function (u) {
              return u.id === upa.value;
            });
            ...
            return [4
            /*yield*/
            , client.get("/ut?orderBy=nome&order=asc&upa=" + upaSelected.id)];
  ...
  var selectUt = function selectUt(ut) {
    return __awaiter(void 0, void 0, void 0, function () {
      var paginatedData;
      return __generator(this, function (_a) {
        dispatch(utSlice_1.setUt({
  ...
  var goToAddForm = function goToAddForm() {
    if (ut.numero_ut.toString() === 'Todos' || _typeof(ut) === undefined) {
  ...
  var sortArvores = function sortArvores(sortBy) {
  ...
  return React.createElement("div", null, React.createElement("div", {
    className: "flex flex-row items-center justify-between p-6 bg-gray-100 items-center"
  }, React.createElement("h1", {
    className: "font-medium text-2xl font-roboto"
  }, "\xC1rvores"), React.createElement("div", {
    className: "flex flex-row space-x-2"
  }, React.createElement("div", {
    onClick: exportCsv,
    className: "px-4 py-2 text-white bg-green-700 hover:bg-green-800 rounded-md hover:cursor-pointer"
  }, React.createElement("div", {
    className: "flex flex-row justify-around w-full space-x-2"
  }, React.createElement("div", null, React.createElement(react_fontawesome_1.FontAwesomeIcon, {
    icon: free_solid_svg_icons_1.faFileExport
  })), React.createElement("span", null, "Exportar"))), React.createElement("div", {
    onClick: goToAddForm,
    ...
    className: "grid grid-cols-1 md:grid-cols-3 gap-4 w-full px-4"
  }, React.createElement("div", null, React.createElement(Select_1.Select, {
    initialData: {
      label: 'Selecione UMF...',
      value: ''
    },
    ...
    className: "w-full px-4 pt-4 lg:pt-0"
  }, React.createElement("label", {
    htmlFor: "procurar_ut"
  }, "Pesquisar \xC1rvore:"), React.createElement(input_1.Input, {
    label: "Pesquisar UT",
    id: "search",
    name: "search",
    value: searchInput,
  ...
  }))), React.createElement(ListArvore_1["default"], {
