...
var AddEdit = function () {
    ...
    var _b = react_1.useState(), observacao = _b[0], setObservances = _b[1];
    var _c = react_1.useState(), observacoes = _c[0], setObservacoes = _c[1];
    var _d = react_1.useState(), especie = _d[0], setEspecie = _d[1];
    var _e = react_1.useState(), especies = _e[0], setEspecies = _e[1];
    var _f = react_1.useState({ label: 'DIR', value: 'D' }), orient_x = _f[0], setOrientX = _f[1];
    var _g = react_1.useState(), medicao = _g[0], setMedicao = _g[1];
    var _h = react_1.useState(1), fuste = _h[0], setFuste = _h[1];
    ...
    var loadObsOptions = function (inputValue, callback) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            data = observacoes.filter(function (o) { return o.nome.toLowerCase().includes(inputValue) || o.nome.includes(inputValue); });
            callback(data === null || data === void 0 ? void 0 : data.map(function (observacao) { return ({
                value: observacao.id,
    ...
    var loadEspecieOptions = function (inputValue, callback) { return __awaiter(void 0, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            data = especies.filter(function (e) { return e.nome.toLowerCase().includes(inputValue) || e.nome.includes(inputValue); });
                ...
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        ...
                        case 1:
                            ...
                            setFuste(arvore === null || arvore === void 0 ? void 0 : arvore.fuste);
                            setEspecie({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, client.get("/obs-arvore?order=asc&orderBy=nome")];
                    case 1:
                        response = _a.sent();
        ...
        var defaultEspecieOptions = function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(typeof session !== typeof undefined)) return [3 /*break*/, 2];
                        return [4 /*yield*/, client.get("/especie?order=asc&orderBy=especie.nome")];
                    case 1:
                        response = _a.sent();
    ...
    function onSubmit(data) {
        return __awaiter(this, void 0, void 0, function () {
            var preparedData;
            return __generator(this, function (_a) {
                preparedData = __assign(__assign({}, data), { fuste: fuste, orient_x: orient_x === null || orient_x === void 0 ? void 0 : orient_x.value, id_projeto: projeto === null || projeto === void 0 ? void 0 : projeto.id, id_observacao: (observacao === null || observacao === void 0 ? void 0 : observacao.value) && (observacao === null || observacao === void 0 ? void 0 : observacao.value), id_especie: (especie === null || especie === void 0 ? void 0 : especie.value) && (especie === null || especie === void 0 ? void 0 : especie.value) });
                try {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                client.post("/arvore", __assign({ upa: upa === null || upa === void 0 ? void 0 : upa.id, ut: ut === null || ut === void 0 ? void 0 : ut.id }, data))
                    ...
                    var _a = response.data, error = _a.error, arvore = _a.arvore, message = _a.message;
                    if (!error) {
                    ...
                    React.createElement("form", { onSubmit: handleSubmit(onSubmit) },
                        React.createElement("div", { className: 'grid grid-cols-3 lg:grid-cols-5 gap-4' },
                            React.createElement("div", { className: 'col-span-3 lg:col-span-5 w-48' },
                                React.createElement(RadioGroup_1["default"], { labelText: "Medi\u00E7\u00E3o" }, ["DAP", "CAP"].map(function (el, index) { return (React.createElement(Option_1["default"], { key: index, index: index, selectedIndex: medicao ? medicao : 0, onSelect: function (index) {
                                        onSelect(index);
                                    } }, el)); }))),
                            React.createElement("div", null,
                            ...
                            (upa.tipo === 1) ? (React.createElement(React.Fragment, null,
                                ...
                                React.createElement("div", null,
                                    React.createElement(FormInput_1.FormInput, { id: "long_x", name: "long_x", label: "Coord. X", register: register, errors: errors, rules: { required: 'O campo nome é obrigatório' }, className: "pb-4" })),
                                ...
                                React.createElement("div", null,
                                    React.createElement(FormInput_1.FormInput, { id: "long_x", name: "long_x", label: "Coord. Y", register: register, errors: errors, rules: { required: 'O campo nome é obrigatório' }, className: "pb-4" })))) : (React.createElement(React.Fragment, null,
                                React.createElement("div", { className: 'lg:col-span-1 lg:w-full col-span-2 w-[7.5rem]' },
                                    React.createElement(FormInput_1.FormInput, { name: "ponto_gps", label: "Ponto", register: register, errors: errors, rules: { required: 'O campo nome é obrigatório' }, id: "ponto_gps", className: "pb-4" })))),
                            (medicao === 1) ? (React.createElement(React.Fragment, null,
                                React.createElement("div", null,
                            ...
                            React.createElement("div", { className: "flex flex-col px-4 w-auto pt-1" },
                                React.createElement("div", null,
                                    React.createElement("label", { htmlFor: "perPage", className: "px-1 text-sm" }, "Fuste *")),
                                React.createElement("select", { value: fuste, onChange: function (e) { return setFuste(e.target.value); }, id: "fuste", className: "w-24 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" },
