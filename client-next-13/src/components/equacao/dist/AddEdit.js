...
exports.AddEdit = react_1.forwardRef(function AddEdit(_a, ref) {
    ...
    var validationSchema = Yup.object().shape({
        ...
        expressao: Yup.string()
            .test("len", "A expressão tem que ter entre 3 e 200 caracteres.", function (val) {
            return val &&
                val.toString().length >= 3 &&
                        ...
                        React.createElement(formik_1.Form, null,
                            React.createElement("div", { className: 'flex flex-col' },
                                React.createElement("div", null,
                                    ...
                                    React.createElement(formik_1.Field, { className: styles.field, id: "nome", name: "nome", placeholder: "Nome da Equa\u00E7\u00E3o" }),
                                ...
                                React.createElement("div", null,
                                    ...
                                    React.createElement(formik_1.Field, { className: styles.field, id: "expressao", name: "expressao", placeholder: "0.7 * (3.141592 * (DAP ^ 2) / 40000 ) * ALTURA ..." }),
