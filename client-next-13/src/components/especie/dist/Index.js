...
var Index = function (_a) {
    ...
    var _b = react_1.useState([]), filteredEspecies = _b[0], setFilteredEspecies = _b[1];
    ...
    var importModal = function () {
        showModal({
            ...
            size: 'max-w-4xl',
            type: 'submit', hookForm: 'hook-form', styleButton: styles_1.styles.greenButton, confirmBtn: (step === steps.length) ? "Finalizar" : "Prosseguir",
            options: false,
            content: React.createElement("div", null,
                React.createElement(ImportModal_1["default"], { loadEspecies: loadEspecies, ref: submitImport, steps: steps, callback: callBackImport }))
        });
    };
    ...
    var deleteEspecies = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, client.post('/especie/multiples', { ids: checkedEspecies })
                            .then(function () {
                            setCheckedEspecies([]);
            ...
            React.createElement("div", { className: "flex flex-row items-center justify-between overflow-x-auto mt-2" },
                React.createElement("div", { className: "shadow overflow-y-auto border-b border-gray-200 w-full sm:rounded-lg" },
                    ...
                    React.createElement("table", { className: "min-w-full divide-y divide-gray-200" },
                        ...
                        React.createElement("tbody", { className: "bg-white divide-y divide-gray-200" }, currentEspecies === null || currentEspecies === void 0 ? void 0 : currentEspecies.map(function (especie, idx) {
                            var _a;
                            return (React.createElement("tr", { key: idx },
                                React.createElement("td", { className: "flex justify-center" },
                                    React.createElement("input", { value: especie === null || especie === void 0 ? void 0 : especie.id, checked: checkedEspecies === null || checkedEspecies === void 0 ? void 0 : checkedEspecies.includes(especie === null || especie === void 0 ? void 0 : especie.id), onChange: handleSelectEspecie, id: "especieId", type: "checkbox", className: "form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" })),
                                ...
                                React.createElement("td", { className: "px-3 py-2 whitespace-nowrap" },
                                    React.createElement("span", { className: "text-sm font-medium text-gray-900" },
                                        React.createElement("div", { className: "text-sm text-gray-500" }, (_a = especie === null || especie === void 0 ? void 0 : especie.categoria) === null || _a === void 0 ? void 0 : _a.nome))),
