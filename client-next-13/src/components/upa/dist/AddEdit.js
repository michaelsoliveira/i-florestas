...
var AddEdit = function () {
    ...
    var _b = react_1.useState(), equacao_volume = _b[0], setEquacao = _b[1];
    var _c = react_1.useState(), equacoes = _c[0], setEquacoes = _c[1];
    var _d = react_1.useState(), sysRef = _d[0], setSysRef = _d[1];
    var _e = react_1.useState(), sysRefs = _e[0], setSysRefs = _e[1];
    ...
    var loadSysRefs = function (inputValue, callback) { return __awaiter(void 0, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            data = sysRefs.filter(function (srid) { var _a; return (_a = srid.srtext) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(inputValue); });
            console.log(data);
