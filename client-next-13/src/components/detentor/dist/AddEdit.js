...
var PessoaFisica_1 = require("../Form/PessoaFisica");
var PessoaJuridica_1 = require("../Form/PessoaJuridica");
...
var AddEdit = function () {
    ...
    var loadDetentor = react_1.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0: return [4 /*yield*/, client.get("/detentor/" + (projeto === null || projeto === void 0 ? void 0 : projeto.id))];
                case 1:
                    data = (_g.sent()).data;
                    setDetentor(data);
            ...
            return __generator(this, function (_a) {
                try {
                    return [2 /*return*/, isAddMode
                            ...
                            : updateDetentor(detentor === null || detentor === void 0 ? void 0 : detentor.id, __assign(__assign({}, data), { id_projeto: projeto === null || projeto === void 0 ? void 0 : projeto.id, tipo: tipoPessoa === 0 ? 'F' : 'J' }))];
                }
                catch (error) {
