        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, axios_1.apiClient().post("/especie", dataRequest, headers)];
                case 2:
                    data = (_b.sent()).data;
                    return [2 /*return*/, {
                            data: data.especie,
    ...
    return __awaiter(this, void 0, Promise, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), provider = _a.provider, headers = _a.headers;
                    return [4 /*yield*/, axios_1.apiClient().put("/especie/" + id, dataRequest, headers)];
                case 2:
                    data = (_b.sent()).data;
                    return [2 /*return*/, {
                            data: data.especie,
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), provider = _a.provider, headers = _a.headers;
                    return [4 /*yield*/, axios_1.apiClient().get("/especie", headers)
    ...
    return __awaiter(this, void 0, Promise, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), provider = _a.provider, headers = _a.headers;
                    return [4 /*yield*/, axios_1.apiClient().get("/especie/" + id, headers)];
                case 2:
                    response = _b.sent();
                    return [2 /*return*/, {
                            data: response.data,
    ...
    return __awaiter(this, void 0, Promise, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), provider = _a.provider, headers = _a.headers;
                    return [4 /*yield*/, axios_1.apiClient()["delete"]("/especie/" + id, headers)];
                case 2:
                    _b.sent();
                    return [2 /*return*/];
            }
...
exports["default"] = especieService;
