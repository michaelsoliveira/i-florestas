...
var ObservacaoService = /** @class */ (function () {
    function ObservacaoService() {
    }
    ObservacaoService.prototype.create = function (data) {
    ...
    ObservacaoService.prototype.update = function (id, data) {
        return __awaiter(this, void 0, Promise, function () {
            var observacao;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ObservacaoService.prototype["delete"] = function (id) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ObservacaoService.prototype.getAll = function (userId, query) {
        return __awaiter(this, void 0, Promise, function () {
    ...
    ObservacaoService.prototype.deleteCategorias = function (observacoes) {
    ...
    ObservacaoService.prototype.search = function (q, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ObservacaoService.prototype.findById = function (id) {
        return __awaiter(this, void 0, Promise, function () {
            var observacao;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports["default"] = new ObservacaoService;
