...
var EspecieIndex = function () {
    ...
    return (React.createElement("div", null, loading ? (React.createElement("div", { className: "flex flex-row items-center justify-center h-full w-full" },
        React.createElement(Loading_1.Loading, null))) : (React.createElement("div", null,
