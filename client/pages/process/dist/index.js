...
var Index_1 = require("components/process/Index");
var PoaIndex = function () {
    ...
    var _e = react_1.useState([]), currentPoas = _e[0], setCurrentPoas = _e[1];
    ...
    var loadPoas = react_1.useCallback(function (itemsPerPage, currentPage) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    url = "/poa?page=" + (currentPage ? currentPage : currentPagePagination) + "&perPage=" + (itemsPerPage ? itemsPerPage : pagination.perPage) + "&orderBy=" + orderBy + "&order=" + order + "&umf=" + umf.id;
                    return [4 /*yield*/, client.get(url)];
                case 1:
                    data = (_a.sent()).data;
                    setTotalItems(data === null || data === void 0 ? void 0 : data.count);
                    setCurrentPoas(data === null || data === void 0 ? void 0 : data.poas);
                    setLoading(false);
                    return [2 /*return*/];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    url = "/poa?page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order + "&umf=" + umf + "&search=" + search;
                ...
                case 1:
                    ...
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, client.get("/poa?page=" + currentPage + "&perPage=" + perPage + "&orderBy=" + orderBy + "&order=" + order + "&umf=" + umf)];
                case 3:
                    data = (_a.sent()).data;
                    paginatedData = __assign(__assign({ name: name }, paginatedData), { totalPages: Math.ceil((data === null || data === void 0 ? void 0 : data.count) / perPage), totalItems: data === null || data === void 0 ? void 0 : data.count });
                    _a.label = 4;
    ...
    return (React.createElement("div", null,
        React.createElement(Index_1["default"], { currentPoas: currentPoas, loading: loading, loadPoas: loadPoas, currentPage: currentPage, orderBy: orderBy, order: order, onPageChanged: onPageChanged, perPage: itemsPerPage, changeItemsPerPage: changeItemsPerPage }),
