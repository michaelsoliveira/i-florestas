...
exports.AddEdit = function (_a) {
    ...
    return (React.createElement("div", { className: 'mt-4 p-4 border-gray-200 border rounded-md' },
        React.createElement("form", { onSubmit: handleSubmit(onSubmit), id: "hook-form" },
            ...
            React.createElement(FormInput_1.FormInput, { layout: 'floatLabel', id: "active", name: "active", label: "Ativo?", type: "checkbox", register: register, errors: errors, className: "w-[10rem]" }))));
};
exports["default"] = exports.AddEdit;
