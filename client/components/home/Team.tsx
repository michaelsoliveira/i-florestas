    ...
    <div className="container xl:max-w-6xl mx-auto px-4">
        ...
        <header className="text-center mx-auto mb-12">
            ...
            <div className="my-0 mx-auto h-10">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 100 60" >
                    <circle cx="50.1" cy="30.4" r="5" className="stroke-primary" style={styles.svgt}></circle>
                    <line x1="55.1" y1="30.4" x2="100" y2="30.4" className="stroke-primary" style={styles.svg}></line>
                    <line x1="45.1" y1="30.4" x2="0" y2="30.4" className="stroke-primary" style={styles.svg}></line>
                </svg>
            </div>
        </header>
        ...
        <div className="flex flex-wrap flex-row -mx-4 justify-center">
            <div className="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                <div className="relative overflow-hidden bg-white dark:bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">
            ...
            <div className="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                ...
                <div className="relative overflow-hidden bg-white dark:bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInUp;">
                    <div className="relative overflow-hidden px-6">
            ...
            <div className="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                ...
                <div className="relative overflow-hidden bg-white dark:bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.3s; animation-name: fadeInUp;">
                    <div className="relative overflow-hidden px-6">
            ...
            <div className="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                ...
                <div className="relative overflow-hidden bg-white dark:bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s; animation-name: fadeInUp;">
                    <div className="relative overflow-hidden px-6">
