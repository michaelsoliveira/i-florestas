...
const SelectableRowList = ({ data }: any) => {
  ...
  return (
    <div className='w-full'>
      <div className="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem] text-xs">
        <input
      ...
      <ul className="w-48 text-xs text-gray-900 bg-white border border-gray-200 rounded-lg">
