...
function Modal(props) {
    ...
    var styleButton = store.styleButton, className = store.className, title = store.title, size = store.size, visible = store.visible, confirmBtn = store.confirmBtn, onConfirm = store.onConfirm, iconType = store.iconType, content = store.content, type = store.type, hookForm = store.hookForm, layout = store.layout;
    ...
    return (React.createElement(react_2.Transition.Root, { show: visible || false, as: react_1.Fragment },
        React.createElement(react_2.Dialog, { as: "div", className: classNames_1["default"]("fixed z-50 inset-0 overflow-y-auto text-sm", className), 
            ...
            React.createElement("div", { className: "flex items-center justify-center min-h-screen pt-4 px-4 text-center sm:block sm:p-0 w-full" },
                ...
                React.createElement(react_2.Transition.Child, { as: react_1.Fragment, enter: "ease-out duration-300", enterFrom: "opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95", enterTo: "opacity-100 translate-y-0 sm:scale-100", leave: "ease-in duration-200", leaveFrom: "opacity-100 translate-y-0 sm:scale-100", leaveTo: "opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" },
                    React.createElement("div", { className: classNames_1["default"]('inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle', size ? size : 'sm:max-w-2xl') },
                        React.createElement("div", null,
                            React.createElement("div", { className: "bg-white px-4" },
                                React.createElement("div", { className: "sm:flex sm:items-center py-2" },
                                    ...
                                    React.createElement("div", { className: "pt-2 py-2 px-2" },
                                        React.createElement("div", { className: 'flex flex-row justify-between items-center py-2' },
                                            React.createElement(react_2.Dialog.Title, { as: "h3", className: "text-lg leading-6 font-medium text-gray-900" }, title),
                                            (type && type === 'submit') && (React.createElement("div", { className: 'hover:cursor-pointer align-top', onClick: hideModal },
