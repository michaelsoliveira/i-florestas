...
function Modal(props) {
    var title = props.title, buttonText = props.buttonText, bodyText = props.bodyText, styleButton = props.styleButton, parentFunction = props.parentFunction, hideModal = props.hideModal, open = props.open, data = props.data, className = props.className;
