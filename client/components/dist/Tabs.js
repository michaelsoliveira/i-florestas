    ...
    return (React.createElement("div", { className: "w-full py-4" },
        React.createElement(react_1.Tab.Group, null,
            ...
            React.createElement(react_1.Tab.Panels, { className: "mt-2" },
                ...
                React.createElement(react_1.Tab.Panel, { className: classnames_1["default"]('bg-white shadow-lg rounded-xl px-4 py-2 text-left mx-auto flex flex-wrap justify-center items-center') },
                    React.createElement(AddEdit_1.AddEdit, { styles: styles, redirect: true }))))));
};
