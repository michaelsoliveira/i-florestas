    ...
    return (react_2["default"].createElement("div", { className: "w-full py-4" },
        react_2["default"].createElement(react_1.Tab.Group, null,
            ...
            react_2["default"].createElement(react_1.Tab.Panels, { className: "mt-2" },
                react_2["default"].createElement(react_1.Tab.Panel, { className: classnames_1["default"]('bg-white shadow-lg rounded-xl px-6 py-4') },
                    react_2["default"].createElement(Login_1["default"], null)),
                react_2["default"].createElement(react_1.Tab.Panel, { className: classnames_1["default"]('bg-white shadow-lg rounded-xl px-4 py-2 text-left mx-auto flex flex-wrap justify-center items-center') },
                    react_2["default"].createElement("div", { className: "flex flex-col items-center justify-between w-full" },
                        react_2["default"].createElement(AddEdit_1.AddEdit, { ref: formRef, styles: styles, redirect: true }),
