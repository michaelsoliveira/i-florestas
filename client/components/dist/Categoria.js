            ...
            React.createElement("div", { className: "relative py-3 w-11/12 max-w-none lg:max-w-2xl mx-auto" },
                ...
                React.createElement("div", { className: "relative p-8 bg-white shadow-sm sm:rounded-b-xl" },
                    React.createElement("form", { onSubmit: handleSubmit(onSubmit) },
                        ...
                        React.createElement("div", { className: 'flex flex-row space-x-0 md:space-x-4' },
                            React.createElement("div", null,
                            ...
                            React.createElement("div", null,
                                React.createElement(FormInput_1.FormInput, { id: "criterioVolume", name: "criterioVolume", label: "Volume m\u00E1ximo da \u00E1rvore", type: "number", register: register, errors: errors, rules: {
                                        valueAsNumber: true,
                                        pattern: {
                                            value: /^[0-9]+$/,
                                            message: 'Por favor entre com um valor numérico'
