...
exports.Select = function (_a) {
    var label = _a.label, callback = _a.callback, options = _a.options, defaultOptions = _a.defaultOptions, initialData = _a.initialData, selectedValue = _a.selectedValue, _b = _a.isMulti, isMulti = _b === void 0 ? false : _b;
