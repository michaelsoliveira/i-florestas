...
var Especies = function (_a) {
    ...
    var _e = react_1.useState(false), singleModel = _e[0], setOpenSingleModal = _e[1];
    ...
    var _h = react_1.useState([]), checkedEspecies = _h[0], setCheckedEspecies = _h[1];
    ...
    return (React.createElement("div", null,
        ...
        loading ? (React.createElement("div", { className: "flex flex-row items-center justify-center h-56" }, "Loading...")) : (React.createElement("div", { className: "flex flex-col p-6" },
                    ...
                    React.createElement("table", { className: "min-w-full divide-y divide-gray-200" },
                        React.createElement("thead", { className: "bg-gray-50" },
                            React.createElement("tr", null,
                                ...
                                React.createElement("th", { scope: "col", className: "flex flex-row items-center w-auto px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer", onClick: function () { return sortEspecies('especie.nome'); } },
                                    "Nome",
                                    sorted
            ...
            singleModel &&
                React.createElement(Modal_1["default"], { className: "w-full", styleButton: "bg-red-600 hover:bg-red-700 focus:ring-red-500", title: "Deletar esp\u00E9cie", buttonText: "Deletar", bodyText: "Tem certeza que seja excluir a especie " + (selectedEspecie === null || selectedEspecie === void 0 ? void 0 : selectedEspecie.nome) + "?", data: selectedEspecie, parentFunction: deleteEspecie, hideModal: function () { return setOpenSingleModal(false); }, open: singleModel }),
            removeMultipleModal &&
                React.createElement(Modal_1["default"], { className: "w-full", styleButton: "bg-red-600 hover:bg-red-700 focus:ring-red-500", title: "Deletar UMFs", buttonText: "Deletar", bodyText: "Tem certeza que seja excluir as " + (checkedEspecies === null || checkedEspecies === void 0 ? void 0 : checkedEspecies.length) + " UMFs selecionados?", data: checkedEspecies, parentFunction: deleteEspecies, hideModal: function () { return setOpenMultipleModal(false); }, open: removeMultipleModal })))));
};
