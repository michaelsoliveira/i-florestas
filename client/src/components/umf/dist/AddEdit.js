...
var AddEdit = function (_a) {
    ...
    return (React.createElement("div", { className: "py-6 flex flex-col justify-center sm:py-12 bg-gray-50" },
        React.createElement("div", { className: "relative py-3 w-11/12 max-w-none lg:max-w-2xl mx-auto" },
            React.createElement("div", { className: 'flex flex-row items-center justify-between border border-custom-green text-white shadow-lg bg-custom-green py-4 sm:rounded-t-xl' },
                ...
                React.createElement("div", null, !id ? (React.createElement("h1", { className: 'text-xl' }, "Cadastrar UMF")) : (React.createElement("h1", { className: 'text-xl' }, "Editar UMF"))),
                React.createElement("div", null)),
