...
var AddEdit = function () {
    ...
    var _b = react_1.useState(), categoria = _b[0], setCategoria = _b[1];
    ...
    var loadOptions = function (inputValue, callback) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.get("/categoria?poa=" + (poa === null || poa === void 0 ? void 0 : poa.id) + "&projetoId=" + (projeto === null || projeto === void 0 ? void 0 : projeto.id) + "&order=asc&orderBy=nome&search=" + inputValue)];
                case 1:
                    response = _a.sent();
                    json = response.data;
    ...
    react_1.useEffect(function () {
        function loadEspecie() {
            return __awaiter(this, void 0, void 0, function () {
                var especie, _i, _a, _b, key, value;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            if (!(!isAddMode && typeof session !== typeof undefined)) return [3 /*break*/, 2];
                            return [4 /*yield*/, client.get("/especie/" + id + "?poa=" + (poa === null || poa === void 0 ? void 0 : poa.id))];
                        case 1:
                            especie = (_c.sent()).data;
                            setCategoria({
                                label: especie === null || especie === void 0 ? void 0 : especie.nome_categoria,
                                value: especie === null || especie === void 0 ? void 0 : especie.id_categoria
                            });
                            for (_i = 0, _a = Object.entries(especie); _i < _a.length; _i++) {
        ...
        loadEspecie();
    }, [session, isAddMode, client, id, setValue, setCategoria, poa === null || poa === void 0 ? void 0 : poa.id]);
    react_1.useEffect(function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, client.get("/categoria?poa=" + (poa === null || poa === void 0 ? void 0 : poa.id) + "&projetoId=" + (projeto === null || projeto === void 0 ? void 0 : projeto.id) + "&order=asc&orderBy=nome")];
                    case 1:
                        response = _a.sent();
        ...
        defaultOptions();
    }, [session, client, projeto === null || projeto === void 0 ? void 0 : projeto.id, poa === null || poa === void 0 ? void 0 : poa.id]);
    ...
    function onSubmit(data) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                preparedData = __assign(__assign({}, data), { id_projeto: projeto === null || projeto === void 0 ? void 0 : projeto.id, id_categoria: (_a = categoria === null || categoria === void 0 ? void 0 : categoria.value) !== null && _a !== void 0 ? _a : categoria === null || categoria === void 0 ? void 0 : categoria.value });
                try {
    ...
    function updateEspecie(id, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                client.put("/especie/" + id + "?poa=" + (poa === null || poa === void 0 ? void 0 : poa.id), data)
                    .then(function (response) {
                    var _a = response.data, error = _a.error, message = _a.message;
                    if (!error) {
                        alert_1["default"].success(message);
            ...
            React.createElement("div", { className: "relative py-3 w-11/12 max-w-xl mx-auto" },
                ...
                React.createElement("div", { className: "relative p-8 bg-white shadow-sm sm:rounded-b-xl" },
                    React.createElement("form", { className: "w-full", onSubmit: handleSubmit(onSubmit) },
                        React.createElement(FormInput_1.FormInput, { name: "nome", label: "Nome Vulgar (empresa)", register: register, errors: errors, rules: { required: 'O campo nome é obrigatório' }, id: "nome", className: "pb-4" }),
                        React.createElement(FormInput_1.FormInput, { id: "nome_orgao", name: "nome_orgao", label: "Nome Vulgar (\u00D3rg\u00E3o Ambiental)", register: register, errors: errors, rules: {
                                minLength: {
                                    value: 3,
                                    message: 'Por favor, preencha o campo com no mínimo 3 caracteres'
                                }
                            }, className: "pb-4" }),
                        React.createElement(FormInput_1.FormInput, { id: "nome_cientifico", name: "nome_cientifico", label: "Nome Cient\u00EDfico", register: register, errors: errors, rules: {
                                minLength: {
                                    value: 3,
                                    message: 'Por favor, preencha o campo com no mínimo 3 caracteres'
                                }
